...
//   /** methods **/
//   init() {
//     const parentComponentTagName = getChartComponentTag(this.$parent.$options as OptionsINF)
//     const currentComponentTagName = getChartComponentTag(this.$options as OptionsINF)
//     if (parentComponentTagName === "createView") {
//       Object.keys(this.allAttrs).forEach(key => {
//         if (this.viewOptions[key]) {
//           this.viewOptions[key].push()
//         }
//       })
//     }
//   }
